            ...
            <div class="col-lg-6">
                ...
                <form class="form-horizontal" id="jfsc-form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" name="p_Name" class="form-control" id="productname" placeholder="请填写商品名称" value="<?php echo ($product["p_Name"]); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="pricee" class="col-sm-2 control-label">价格:</label>
                        <div class="col-sm-5">
                            <input type="text" name="price" class="form-control" id="pricee" placeholder="请填写商品价格" value="<?php echo ($product["price"]); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="number" class="col-sm-2 control-label">数量:</label>
                        <div class="col-sm-5">
                            <input type="text" name="pNum" class="form-control" id="number" placeholder="请填写浏览次数" value="<?php echo ($product["pNum"]); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            ...
                            <img  id="upload_org_code_img" src="<?php echo ($product["pImg"]); ?>" width="150" height="150">
                            <input id="file_upload_image" name="pImg" type="hidden" multiple="true" value="<?php echo ($product["pImg"]); ?>" >
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select class="form-control" name="type">
                                <?php if(is_array($typei)): $i = 0; $__LIST__ = $typei;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value=''>--------<?php echo ($vo["type_name"]); ?>--------</option>
                                    <?php if(is_array($vo["child"])): $i = 0; $__LIST__ = $vo["child"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><option value='<?php echo ($list["type_id"]); ?>' <?php if($product[type] == $list[type_name]): ?>selected="selected"<?php endif; ?>><?php echo ($list["type_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <textarea class="input js-editor" id="editor_lw" name="pDesc" rows="20" ><?php echo ($product["pDesc"]); ?></textarea>
                        </div>
                    </div>
                    <div class="form-group" style="width:1200px;">
                        <label  class="col-sm-2 control-label" >关键字:</label>
                        <div class="col-sm-10" style="width: 900px;">
                            <input style="width: 80px;display: inline-block;margin-right: 10px;" type="text" class="form-control keywords"  value="<?php echo ($keyword_arr[0]); ?>" >
                            <input style="width: 80px;display: inline-block;margin-right: 10px;" type="text" class="form-control keywords"  value="<?php echo ($keyword_arr[1]); ?>" >
                            <input style="width: 80px;display: inline-block;margin-right: 10px;" type="text" class="form-control keywords"  value="<?php echo ($keyword_arr[2]); ?>">
                            <input style="width: 80px;display: inline-block;margin-right: 10px;" type="text" class="form-control keywords" value="<?php echo ($keyword_arr[3]); ?>" >
                            <input style="width: 80px;display: inline-block;margin-right: 10px;" type="text" class="form-control keywords"  value="<?php echo ($keyword_arr[4]); ?>">
                            <input style="width: 80px;display: inline-block;margin-right: 10px;" type="text" class="form-control keywords"  value="<?php echo ($keyword_arr[5]); ?>">
