                ...
                <div class="col-lg-6">
                    ...
                    <form class="form-horizontal" id="jfsc-form">
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" name="typename" class="form-control" id="inputname" placeholder="请填写下级分类" value="<?php echo ($restype["type_name"]); ?>">
                            </div>
                        </div>
                        <input type="hidden" value="<?php echo ($restype["type_id"]); ?>" name="id">
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                <button type="button" class="btn btn-default" id="jfsc-button-submit">保存</button>
                                <button type="button" class="btn btn-default jfsc-delete" attr-id="<?php echo ($restype["type_id"]); ?>" style="margin-left:20px;">删除</button>
...
<script>
    ...
    var SCOPE = {
        'save_url' : '/jfsc/admin.php?c=protype&a=typesave',
