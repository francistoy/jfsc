...
<div class="header">
	...
	<div class="cart-items" style="padding-bottom: 10px ">
		<div class="container">
			<h2 style="margin-bottom:10px;font-size: 26px;">我的订单</h2>
    ...
    <div class="jifenbiao" style="width:83%;margin-left: auto;margin-right: auto;margin-bottom: 20px;">
		<table class="jifentable">
		   ...
		   <?php if(is_array($orderes)): foreach($orderes as $key=>$vo): ?><tr>
				<td><?php echo ($vo["order_num"]); ?></td>
				<td><?php echo ($vo["order_proname"]); ?></td>
				<td><?php echo ($vo["order_time"]); ?></td>
				<td><?php echo ($vo["order_jifen"]); ?></td>
				<td><?php echo (status($vo["order_status"])); ?></td>
				<td>
					<p style="margin-top: 10px;"><a href="/jfsc/index.php?c=Jifen&a=orderdetail&order_num=<?php echo ($vo["order_num"]); ?>&type_name=<?php echo ($vo["order_proname"]); ?>&uid=<?php echo ($vo["order_uid"]); ?>">查看</a></p>
					<?php if($vo[order_status] == 3): ?><p style="margin-top: 10px;"><a  href="javascript:void(0);" class="sureorder" attr-id="<?php echo ($vo["order_num"]); ?>">确认收货</a></p><?php endif; ?>
					<?php if($vo[order_status] == 4): ?><p style="margin-top: 10px;"><a href="javascript:void(0);" class="deleteorder" attr-id="<?php echo ($vo["order_num"]); ?>">删除订单</a></p><?php endif; ?>
				</td>
			...
			<div class="col-lg-12" style="width: 1125px;">
				<ul class="pagination" style="float:right;">
					<li >
						...
						<div style="padding-left:5px;float:right;padding-top: 5px;"><span style="font-size:14px; ">到:</span><input type="text" class="yeshu" value="1" style=" line-height: 30px;height: 25px;width: 40px;font-size: 14px;text-align:center;"/><span style="font-size:14px; ">&nbsp;页</span> </div>
						<a href="/jfsc/index.php?c=Jifen&a=jfrecord&user_id=<?php echo ($user_id); ?>&page=<?php echo ($pageres["totalPage"]); ?>" style="float:right;">尾页</a>&nbsp;&nbsp;
						<a href="/jfsc/index.php?c=Jifen&a=jfrecord&user_id=<?php echo ($user_id); ?>&page=<?php echo ($pageres["pageNext"]); ?>" style="float:right;">下一页</a>&nbsp;&nbsp;
						<a href="/jfsc/index.php?c=Jifen&a=jfrecord&user_id=<?php echo ($user_id); ?>&page=<?php echo ($pageres["pagePrev"]); ?>" style="float:right;">上一页</a>&nbsp;&nbsp;
						<a href="/jfsc/index.php?c=Jifen&a=jfrecord&user_id=<?php echo ($user_id); ?>&page=1" style="float:right;" >第一页</a>&nbsp;&nbsp;
...
<script type="text/javascript">
	$('.pagego').click(function()
	{
		...
		window.location.href="/jfsc/index.php?c=Jifen&a=jfrecord&page="+yeshu+"&user_id="+user_id;
	});
	var SCOPE=
	{
