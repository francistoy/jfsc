...
<script src="/jfsc/Public/Index/js/imagezoom.js"></script>
<!-- //js -->
<!-- cart -->
<script src="/jfsc/Public/Index/js/simpleCart.min.js"> </script>
<!-- cart -->
<!-- FlexSlider -->
<script defer src="/jfsc/Public/Index/js/jquery.flexslider.js"></script>
<link rel="stylesheet" href="/jfsc/Public/Index/css/flexslider.css" type="text/css" media="screen" />
<script>
			...
			<div class="single-grids">				
				<div class="col-md-4 single-grid">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="<?php echo ($prodetail["pImg"]); ?>">
								 <div class="thumb-image"> <img src="<?php echo ($prodetail["pImg"]); ?>" data-imagezoom="true" class="img-responsive"> </div>
							</li>
						</ul>
					</div>
				</div>
				<div class="col-md-4 single-grid simpleCart_shelfItem"  style="margin-left: 50px;">
					<h3 id="pro_name"><?php echo ($prodetail["p_Name"]); ?></h3>
					<ul class="size">
						<p style="font-size: 16px;">積分:<span style="padding-left:15px;color:#000" id="proprice"><?php echo ($prodetail["price"]); ?></span></p>
					</ul>
					<ul class="size">
						<p style="font-size: 16px;">剩余數量:<span style="padding-left:15px;color:#000"><?php echo ($prodetail["pNum"]); ?></span></p>
					</ul>
					<div class="galry">

						<div class="clearfix"></div>
					</div>
					<p class="qty"> 兌換數 :  </p><input min="1" type="number" id="quantity" name="quantity" value="1" class="form-control input-small proquality">
					<div class="btn_form">
						<a href="javascript:void(0);" class="add-cart item_add" attr-id="<?php echo ($prodetail["prd_id"]); ?>" attr-user="<?php echo ($Hukcuser); ?>">立即兌換</a>
					</div>
				</div>
				<div class="clearfix"> </div>
			</div>
				...
				<div class="panel panel-default">
					...
					<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
						<div class="panel-body">
							<?php echo (htmlspecialchars_decode($prodetail["pDesc"])); ?>
						</div>
					</div>
				</div>
				<!--<div class="panel panel-default">-->
	...
	<div class="related-products">
		<div class="container">
			...
			<div class="product-model-sec single-product-grids">
				<?php if(is_array($producti)): foreach($producti as $key=>$vo): ?><div class="product-grid single-product clicknum" attr-id="<?php echo ($vo["prd_id"]); ?>">
					<a href="/jfsc/index.php?c=Product&a=prodetail&prd_id=<?php echo ($vo["prd_id"]); ?>">
					<div class="more-product"><span> </span></div>						
					<div class="product-img b-link-stripe b-animate-go  thickbox">
						<img src="<?php echo ($vo["pImg"]); ?>" class="img-responsive" alt="">
						<div class="b-wrapper">
					...
					<div class="product-info simpleCart_shelfItem">
						<div class="product-info-cust prt_name">
							...
							<span class="item_price"><?php echo ($vo["price"]); ?></span>
							<div class="clearfix"> </div>
						</div>												
					</div>
				</div><?php endforeach; endif; ?>
...
//			寻找上级的兄弟节点
		var quality=$(".proquality").val();
		var prd_id=$(this).attr('attr-id');
		var money=$("#proprice").html();
		var prdname=$("#pro_name").html();
